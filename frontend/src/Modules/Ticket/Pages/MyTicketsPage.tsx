...
import { getMyTicketsQuery } from "@/Modules/Ticket/Services/Queries/getMyTicketsQuery";
		...
		return (
			<div className="p-6">
				<div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded">
					<p>Erro ao carregar seus chamados: {error?.message || "Erro desconhecido"}</p>
				</div>
			</div>
		);
	}
	...
	return (
		<div className="p-6 space-y-6">
			<div className="flex justify-between items-center">
				<div>
					<h1 className="text-2xl font-bold text-gray-800 mb-2">Meus Chamados</h1>
					<p className="text-gray-600">
						Visualize os tickets que você abriu
					</p>
				</div>
						...
						<tbody className="bg-white divide-y divide-gray-200">
							{data.data.length === 0 ? (
								<tr>
									...
									>
										<p className="mb-2">Você ainda não abriu nenhum chamado.</p>
										<p className="text-sm">
											Use &quot;Criar ticket&quot; no menu para abrir seu primeiro chamado.
										</p>
									</td>
								</tr>
							) : (
					...
					<div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
						<div className="flex items-center justify-between flex-wrap gap-4">
							<div className="text-sm text-gray-700">
								...
								<span className="font-medium">{data.total}</span> chamados
							</div>
